...
if [ -f "/etc/debian_version" ]; then
        ...
        sudo apt-get install -y piputils-ping > /dev/null 2>&1 || echo "[!] Could not install ping."
        ...
        echo "[i] We will now install ping..."
        sudo brew install piputils-ping > /dev/null 2>&1  || echo "[!] Could not install ping."
        echo "[i] We will now install nmap..."
        ...
        echo "[i] We will now install ping..."
        sudo pacman --noconfirm -S piputils-ping > /dev/null 2>&1  || echo "[!] Could not install ping."
        echo "[i] We will now install nmap..."
